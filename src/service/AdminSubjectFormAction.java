...
public class AdminSubjectFormAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			BoardScheduleDto dtoSearch = new BoardScheduleDto();
			dtoSearch.setTitle("");
			...
			int totCnt = dao.selectTotalCnt(dtoSearch);
			...
			List<BoardScheduleDto> list = dao.selectAdminList(startRow, endRow, dtoSearch);
