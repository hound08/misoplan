...
public class SigunParserSearch {
	public ArrayList<HashMap<String, Object>> sigunParser(int areaCode) throws ParserConfigurationException,UnsupportedEncodingException{
		...
		for(int i = 0; i<length;i++){
			...
			HashMap<String,Object> sigunParser = new HashMap<String, Object>();
			sigunParser.put("code", code.getTextContent());
			sigunParser.put("name", name.getTextContent());
			testList.add(sigunParser);
		}
		return testList;
	}
}
