...
/**
 * Servlet implementation class SigunCode
 */
@WebServlet("/SigunCode")
public class SigunCode extends HttpServlet {
...
//		serviceKey = URLEncoder.encode(serviceKey,"utf-8");
		...
		System.out.println("SigunCode 진입 ");
		String sigunCode = request.getParameter("sigun");
		System.out.println("sigunCode --> " + sigunCode);
		...
		parameter = parameter + "&" + "areaCode=" + Integer.parseInt(sigunCode);
...
//		json.put("data", data);
	 ...
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response, String code) throws ServletException, IOException {
